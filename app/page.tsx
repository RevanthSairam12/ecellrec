...
<h1 className="font-bebas text-4xl font-mono flex justify-center m-10 animate-fade-in-up" style={{animationDelay:'0.7s'}}>Highlights</h1>
        <BlurFade />
      </div>
...
<h1 className="font-bebas text-4xl font-mono flex justify-center m-5 animate-fade-in-up" style={{animationDelay:'0.8s'}}>Resources</h1>
        <BentoGridSecondDemo />
      </div>
...
<h1 className="font-bebas text-4xl font-mono flex justify-center m-5 animate-fade-in-up" style={{animationDelay:'0.9s'}}>Faculty Coordinator</h1>
...
<h1 className="font-bebas text-4xl font-mono flex justify-center m-5 animate-fade-in-up" style={{animationDelay:'1s'}}>Our Team</h1>
        <Team />
      </div>
...
<h1 className="font-bebas text-4xl font-mono flex justify-center m-5 animate-fade-in-up">Testimonials</h1>
        <div id="Testimonials">
          <Testimonials />
        </div>
      </div>
